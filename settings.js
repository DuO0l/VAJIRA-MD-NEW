...
global.owner = process.env.OWNER_NUMBER  || '23470498015554' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || ' VAJIRA-MD=HANCAaSJ#dkUHfV2u21F6CN_YT-TInwH5_y1vfOZmq3cQ5L4nYaI' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "23467735013,23470498015554" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || '10sion' ,
